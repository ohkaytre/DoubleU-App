...
import dynamic from 'next/dynamic'; // Added for dynamic loading
import { MOCK_TRACKS, MOCK_ALBUMS } from '@/lib/mock-data';
import { TrackItem } from '@/components/discography/TrackItem';
// import { TrackInsightPanel } from '@/components/ai/TrackInsightPanel'; // Removed direct import
...
// --- ADDED: Lazy load the panel to prevent Webpack errors ---
const TrackInsightPanel = dynamic(() => import('@/components/ai/TrackInsightPanel').then(mod => mod.TrackInsightPanel), {
  ssr: false,
});
// -----------------------------------------------------------
